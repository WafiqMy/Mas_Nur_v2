...
class UpdateInfaqRekeningRequest extends FormRequest
{
    /**
   ...
   public function authorize()
{
    ...
    public function rules(): array
    {
        return [
            ...
            'nomor_rekening' => 'required|string|max:50|unique:infaq_rekening,nomor_rekening,' . $this->route('rekening')->id,
    ...
    {
        $this->merge([
            'is_active' => $this->boolean('is_active', $this->route('rekening')->is_active),
        ]);
    }
}
