...
<nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top border-bottom shadow-sm" style="z-index: 1030;">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center gap-2" href="{{ route('home') }}">
            <img src="{{ asset('img/logo_masjid.png') }}" alt="Logo" height="38" onerror="this.style.display='none'">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav align-items-center gap-lg-3">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle {{ request()->routeIs('profil-masjid.*') ? 'active fw-semibold' : '' }}" href="#" data-bs-toggle="dropdown">Profil</a>
                ...
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('berita.*') ? 'active fw-semibold' : '' }}" href="{{ route('berita.index') }}">Berita</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('event.*') ? 'active fw-semibold' : '' }}" href="{{ route('event.index') }}">Acara</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('infaq.*') ? 'active fw-semibold' : '' }}" href="{{ route('infaq.index') }}">Infaq</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link {{ request()->routeIs('reservasi.*') ? 'active fw-semibold' : '' }}" href="{{ route('reservasi.index') }}">Sewa Fasilitas</a>
                </li>
                <li class="nav-item">
    <a class="nav-link {{ request()->routeIs('food-court.*') ? 'active fw-semibold' : '' }}" href="{{ route('food-court.index') }}">Food Court</a>
</li>
                ...
                @else
                    {{-- Notifikasi --}}
                    <li class="nav-item">
                        <a href="{{ route('notifikasi.index') }}" class="nav-link position-relative px-2" title="Notifikasi">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle d-flex align-items-center gap-2" href="#" data-bs-toggle="dropdown">
                            <img src="{{ $fotoUrl }}" alt="Foto" class="rounded-circle" width="32" height="32" style="object-fit:cover;" id="navbarFoto">
                            <span class="d-none d-lg-inline fw-semibold" style="font-size:0.9rem;">{{ $namaUser }}</span>
                        </a>
