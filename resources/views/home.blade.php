...
<nav class="navbar navbar-expand-lg navbar-light bg-white fixed-top border-bottom shadow-sm" style="z-index: 1030;">
    <div class="container">
        <a class="navbar-brand d-flex align-items-center gap-2" href="http://127.0.0.1:8000">
            <img src="http://127.0.0.1:8000/img/logo_masjid.png" alt="Logo" height="38" onerror="this.style.display='none'">
        ...
        <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul class="navbar-nav align-items-center gap-lg-3">
                <li class="nav-item">
                    <a class="nav-link active fw-semibold" href="http://127.0.0.1:8000">Beranda</a>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle " href="#" data-bs-toggle="dropdown">Profil</a>
                    <ul class="dropdown-menu shadow border-0 mt-2 p-2">
                        <li><a class="dropdown-item rounded py-2" href="http://127.0.0.1:8000/profil-masjid">
                            <i class="bi bi-building me-2 text-primary"></i>Profil Masjid</a></li>
                        <li><a class="dropdown-item rounded py-2" href="http://127.0.0.1:8000/profil-masjid/struktur">
                            <i class="bi bi-diagram-3 me-2 text-primary"></i>Struktur Organisasi</a></li>
                    </ul>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="http://127.0.0.1:8000/berita">Berita</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="http://127.0.0.1:8000/acara">Acara</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="http://127.0.0.1:8000/infaq">Infaq</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="http://127.0.0.1:8000/reservasi">Sewa Fasilitas</a>
                </li>
                <li class="nav-item">
                    <a href="http://127.0.0.1:8000/login" class="btn btn-primary btn-sm px-3 fw-semibold">
